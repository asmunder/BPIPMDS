...
\begin{figure}
	\centering
	\begin{subfigure}{0.9\linewidth} % width of left subfigure
...
\item Run MS at high temperature (\textit{T}$_{H}$ {\textgreater}{\textgreater} \textit{T}$_{C}$) to generate an initial configuration for the quench. \checkref{See Sec. \ref{sec:setup}.} \\
\end{itemize}
\end{checklist}
